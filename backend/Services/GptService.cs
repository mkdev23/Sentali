    ...
    public async Task<string> GetResponse(string input)
    {
        try
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine($"[Agent] Poll status: {statusRes.StatusCode} {statusBody}");
        ...
        catch (Exception ex)
        {
            ...
            // Option 1: bubble up to controller
            throw;
            // Option 2: return safe string instead of killing request:
