...
public class GptService
{
    ...
    public async Task<string> GetResponse(string input)
    {
        ...
        // 2) Create thread
        var threadCreateUrl = $"{_projectEndpoint}/threads?api-version=2025-05-01";
        var threadRes = await _http.PostAsync(threadCreateUrl,
        ...
        // 4) Create run with assistant_id
        ...
        foreach (var msg in JsonDocument.Parse(messagesJson).RootElement.GetProperty("data").EnumerateArray())
        {
