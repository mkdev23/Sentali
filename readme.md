...
Sentali is not just conversational — it's a security‑focused Copilot.

### 🔐 Security Intelligence & Reasoning
...
Sentali is scalable and team‑friendly, built on Azure Functions.
...
### ♿ Accessibility & UX Intelligence
Sentali supports inclusive design via a Fluent UI webapp.
...
Sentali supports multiple personalities or roles:
...
| Layer       | Technology |
|-------------|------------|
| Frontend    | Unity WebGL, Three.js, WebSocket client |
| Backend     | .NET 9, C#, WebSocket server |
| AI Logic    | Modular service layer (secure‑by‑default) |
| Assets      | VRM avatars, WAV audio files, HDRI backgrounds |
| Build/CI    | GitHub Actions, Docker (optional) |
...
## 📬 Contact
- **GitHub:** [mkdev23](https://github.com/mkdev23)  
- **Maintainer:** Julius
